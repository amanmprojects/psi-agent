...
checkpointer = SqliteSaver(conn=sqlite3.connect(":memory:", check_same_thread=False))
...
messages = [HumanMessage(content="Find 8*8^8/8^8-8")]
messages = agent.invoke(
    {"messages": messages}, config={"configurable": {"thread_id": "abcd123"}}
)
